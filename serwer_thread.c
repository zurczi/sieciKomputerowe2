...
void* cthread (void* arg) {
   ...
   // while(1){
    printf("\nPoczatek while\n");
    memset(wyborCHAR,0,sizeof(char)*2);
   /// read(c->cfd, &wyborCHAR, 1);
    
   

    int pom = read(c->cfd, &wyborCHAR, sizeof(char)*2);
   ...
   // wybor=buffor[1];    
    ...
    memset(odebralemWybor,0,sizeof(odebralemWybor));
    ...
    switch(wybor){
        case 1:{
            ...
            if(ile>0){
                ...
                memset(zajetaNazwa,0,sizeof(zajetaNazwa));
                printf("\nNazwa zajeta\n");
            }
            else{
                ...
                memset(UdaloSieZalogowac,0,sizeof(UdaloSieZalogowac));
        ...
        case 2:{
            ...
            memset(nazwyUzytkownikow,0,sizeof(nazwyUzytkownikow));
        ...
        case 3:{
            ...
            memset(nazwyPokoi,0,sizeof(nazwyPokoi));
            fclose(plik);
           // close(plik2);
            printf("\nSkonczylem case 3");
                    close(c->cfd);
        ...
        case 4:{
          ...
          //  printf("\nTablica nazw uzytkownikow:%s.", listaUzytkownikow);
            ...
            memset(listaUzytkownikow,0,sizeof(listaUzytkownikow));
        ...
        case 5: {
            ...
            sleep(1);
            memset(nazwaPokojuDoDodania,0,sizeof(nazwaPokojuDoDodania));
            ...
            char odebralemNazwePok[3]="13\n";
            write(c->cfd,odebralemNazwePok,3);
            memset(odebralemNazwePok,0,sizeof(odebralemNazwePok));
            iloscCudzyslowiow=0;
            j=0;
            ...
            char nickAdmina[12];
            memset(nickAdmina,0,sizeof(nickAdmina));
           ...
           // pom2=0;
            ...
            write(plik2,"\n",1);
                memset(nickAdmina2,0,sizeof(nickAdmina2));
            char udaloSieZapisacNick[3]="14\n";
            write(c->cfd,udaloSieZapisacNick,3);
            memset(udaloSieZapisacNick,0,sizeof(udaloSieZapisacNick));
            //odbieranie listy uzytkownikow w pokoju
            char listaUzytkownikowPokoju[150];
            memset(listaUzytkownikowPokoju,0,sizeof(listaUzytkownikowPokoju));
            ...
            memset(udaloSieUtworzycPokoj,0,sizeof(udaloSieUtworzycPokoj));
            fclose(plik);
            close(plik2);
            ...
            memset(nowyPokoj,0,sizeof(nowyPokoj));
            close(plik2);           
        ...
        case 6:{
            ...
            memset(odebralemNick,0,sizeof(odebralemNick));
            //odbieram nazwe pokoju (adresata)
            char nazwaPokojuAdresatow[16];
            memset(nazwaPokojuAdresatow,0,sizeof(nazwaPokojuAdresatow));
            read(c->cfd,nazwaPokojuAdresatow,16);
            printf("\nNazwa pokoju - zaraz po odebraniu:%s.",nazwaPokojuAdresatow);
           // printf("\nTu1\n");
            ...
            for(i=1;i<12;i++){
                ...
                printf("\nNazwa pokoju w forze :%c.",nazwaPokojuAdresatow[i]);
                j++;
            }
            printf("\nNazwa pokoju po usunieciu cudzyslowia:%s.",nazwaPokojuAdresatow2);
            
            
            //wysylam potwierdzenie ze odebralam adresata (pokoju) - 3
            char odebralemAdresata[3]="13\n";
            write(c->cfd,odebralemAdresata,3);
            memset(odebralemAdresata,0,sizeof(odebralemAdresata));
            sleep(5);
            printf("\nTu1\n");
            //odbieram wiadomosci
            char wiadomosc[300];
            ...
            printf("\nTresc wiadomosci tuz po odebraniu:%s.",wiadomosc);
            printf("\nTu2\n");
            ...
            memset(wiadomosc2,0,sizeof(wiadomosc2));
            printf("\nSkonczylem case 6");
                    close(c->cfd);
        free(c);
            break;
        ...
        case 7:{
            ...
            memset(udaloSieWylogowac,0,sizeof(udaloSieWylogowac));
            printf("\nSkonczylem case 7");
                    close(c->cfd);
        free(c);
            break;
